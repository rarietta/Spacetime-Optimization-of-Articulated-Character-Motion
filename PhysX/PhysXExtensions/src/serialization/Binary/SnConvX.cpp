...
bool Sn::ConvX::convert(PxInputStream& srcStream, PxU32 srcSize, PxOutputStream& targetStream)
{
	...
	{
		displayMessage(PxErrorCode::eINVALID_OPERATION, __FILE__, __LINE__, 
	...
	if(mPerformConversion)
	{
		...
		if(!srcSize)
		{
			displayMessage(PxErrorCode::eINVALID_PARAMETER, "PxBinaryConverter: source serialized data size is zero.\n");
			return false;
		}
