...
PX_PROFILE_EVENT(BroadPhase, computeAABBUpdateLists, PX_PROFILE_BROADPHASE_PRIORITY)
PX_PROFILE_EVENT(BroadPhase, updateAggLocalSpaceBounds, PX_PROFILE_BROADPHASE_PRIORITY)
PX_PROFILE_EVENT(BroadPhase, updateShapeAABBs, PX_PROFILE_BROADPHASE_PRIORITY)
PX_PROFILE_EVENT(BroadPhase, updateAggAABBs, PX_PROFILE_BROADPHASE_PRIORITY)
PX_PROFILE_EVENT(BroadPhase, updateBroadphase, PX_PROFILE_BROADPHASE_PRIORITY)
PX_PROFILE_EVENT(BroadPhase, SapUpdate, PX_PROFILE_BROADPHASE_PRIORITY)
PX_PROFILE_EVENT(BroadPhase, SapPostUpdate, PX_PROFILE_BROADPHASE_PRIORITY)
PX_PROFILE_EVENT(BroadPhase, SapUpdateSPU, PX_PROFILE_BROADPHASE_PRIORITY)
PX_PROFILE_EVENT(BroadPhase, SapPostUpdateSPU, PX_PROFILE_BROADPHASE_PRIORITY)
PX_PROFILE_EVENT(BroadPhase, MBPUpdate, PX_PROFILE_BROADPHASE_PRIORITY)
PX_PROFILE_EVENT(BroadPhase, MBPPostUpdate, PX_PROFILE_BROADPHASE_PRIORITY)
PX_PROFILE_EVENT(BroadPhase, MBPUpdateSPU, PX_PROFILE_BROADPHASE_PRIORITY)
PX_PROFILE_EVENT(BroadPhase, MBPPostUpdateSPU, PX_PROFILE_BROADPHASE_PRIORITY)
PX_PROFILE_EVENT(BroadPhase, processBPResults, PX_PROFILE_BROADPHASE_PRIORITY)
PX_PROFILE_EVENT(BroadPhase, updateLazyAggShapeAABBs, PX_PROFILE_BROADPHASE_PRIORITY)
PX_PROFILE_EVENT(BroadPhase, computeAggAggShapePairs, PX_PROFILE_BROADPHASE_PRIORITY)
...
PX_PROFILE_EVENT_NO_COMMA(Legacy, PXS_PROFILE_ZONE_FL_HSH_SEC, Detail)
