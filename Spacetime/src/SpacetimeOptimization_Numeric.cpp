...
void
Spacetime::makeInitialGuess_numeric(void)
{
...
double
Spacetime::IterateOptimization_numeric(void)
{	
	//return Synthesis();
	...
	{	
		...
		// apply torque and advance system
		stepPhysics_numeric (uSequence[t]);
